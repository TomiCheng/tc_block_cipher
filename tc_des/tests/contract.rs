...
use tc_des::{
    BLOCK_BYTES, DES_ALGO_NAME, DES_EDE_ALGO_NAME, DES_EDE_KEY_BYTES, DES_KEY_BYTES, DesEdeEngine,
    DesEdeTableEngine, DesEngine, DesTableEngine, EDE2_KEY_BYTES, EDE3_KEY_BYTES,
};
...
fn the_table_engines_keep_the_same_contracts() {
    ...
    parity_is_ignored(DesTableEngine::new(), DES_KEY_BYTES[0]);
    parity_is_ignored(DesEdeTableEngine::new(), EDE2_KEY_BYTES);
    parity_is_ignored(DesEdeTableEngine::new(), EDE3_KEY_BYTES);
}

#[cfg(feature = "rustcrypto")]
#[test]
fn the_rustcrypto_engines_keep_the_same_contracts() {
    ...
    parity_is_ignored(DesRustCryptoEngine::new(), DES_KEY_BYTES[0]);
    parity_is_ignored(DesEdeRustCryptoEngine::new(), EDE2_KEY_BYTES);
    parity_is_ignored(DesEdeRustCryptoEngine::new(), EDE3_KEY_BYTES);
}
